...
public:
    ...
    float setJitter(float j = 1.0f) override {m_maxJit = j; reset(); return m_maxJit;}
...
{
public:
    CorrelatedMultiJitteredInPlace(unsigned x, unsigned y, unsigned dimensions = 2, bool randomize = true, float jitter = 0.0f);
    ...
    std::string name() const override {return "Correlated Multi-Jittered In-Place";}
