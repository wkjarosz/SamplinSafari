...
public:
    ...
    //! Returns an appropriate grid resolution to help visualize the points
    ...
    /*!
        ...
        require a certain number of smaples (e.g. jitter must be n x m),
        find the closest usable number of smaples.
