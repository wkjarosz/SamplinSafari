...
{
public:
    BoseBushOA(unsigned x, OffsetType ot = CENTERED, uint32_t seed = 0, float jitter = 0.0f, unsigned dimensions = 2);
    ~BoseBushOA() override {}
...
{
public:
    BoseBushOAInPlace(unsigned x, OffsetType ot = CENTERED, uint32_t seed = 0, float jitter = 0.0f,
